...
#+begin_src emacs-lisp
  ...
  (add-hook 'modus-themes-after-load-theme-hook #'my/set-modeline-box)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (with-eval-after-load 'doom-modeline
    ...
    (defun my/get-modal-face-attrs (active-p)
      ...
      (if active-p
          `(:background ,(modus-themes-get-color-value 'bg-region)
            :foreground ,(modus-themes-get-color-value 'fg-main)
            :weight bold
            :box (:line-width 4 :color ,(modus-themes-get-color-value 'bg-region)))
        `(:background unspecified
          :foreground ,(modus-themes-get-color-value 'fg-dim)
          :weight normal
          :box (:line-width 4 :color ,(modus-themes-get-color-value 'bg-alt)))))
